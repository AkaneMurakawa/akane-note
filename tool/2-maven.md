...
![image.png](../.gitbook/assets/maven5.png)

![image.png](../.gitbook/assets/maven4.png)
...
![image.png](../.gitbook/assets/maven3.png)
...
![image.png](../.gitbook/assets/maven2.png)
...
$M3\_HOME/lib/maven-model-builder-x.x.x.jar，然后访问路径org/apache/maven/model/pom-4.0.0.xom

### Java系统属性

Maven暴露所有来自于java.lang.System的属性。任何你能从System.getProperty\(\)获取的属性都能以Maven属性的形式引用。下面的表格列出了所有可用的系统属性：

![image.png](../.gitbook/assets/maven1.png)
...
> "-D="这种格式不是Maven定义的，它其实是Java用来设置系统属性的方式，可以通过“java -help”查看
>
